...
import footerSeaUrl from './assets/footer/footer-sea.svg';
...
function Layout() {
  ...
  return (
    <div className="island-shell" style={{ '--animal-cursor': `url(${cursorUrl}) 12 8, auto` }}>
      ...
      <footer className="island-footer" aria-hidden="true">
        <img src={footerSeaUrl} alt="" />
      </footer>

      <button className="music-button radio-widget tilt-card pop-button" type="button" onClick={() => setRadioOpen((open) => !open)}>
